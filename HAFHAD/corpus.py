...
intents = [{
    ...
    "name": "checkcalendar",
    "patterns": [
        'บอกการแจ้งเตือนปฏิทิน','ดูปฏิทิน', 'มีการแจ้งเตือนอะไร','เช็คปฏิทิน','เช็คการแจ้งเตือน',"ดูการแจ้งเตือน","มีการแจ้งเตือน",'เช็คแจ้งเตือน'
    ]
},{
    "name": "setreminder",
    "patterns": [
    ...
    "name": "email",
    "patterns": [
        'เช็คเมล์','เช็คอีเมล','เช็ค inbox','ตรวจอีเมล','ตรวจเมล์'
    ]
}]
